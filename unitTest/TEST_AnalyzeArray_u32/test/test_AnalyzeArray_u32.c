...
void test_factor_u16_32768_mid_range_scaling(void)
{
    ...
    expected_sum_u32 = (uint32_t)((uint16_t)(2U * 32768U)) +
                       (uint32_t)((uint16_t)(3U * 32768U)) +
                       (uint32_t)((uint16_t)(4U * 32768U));
...
void test_factor_u16_65534_near_max_scaling(void)
{
    ...
    expected_sum_u32 = (uint32_t)((uint16_t)(2U * 65534U)) +
                       (uint32_t)((uint16_t)(3U * 65534U));
...
void test_factor_u16_65535_max_scaling(void)
{
    ...
    expected_sum_u32 = (uint32_t)((uint16_t)(2U * 65535U)) +
                       (uint32_t)((uint16_t)(3U * 65535U));
...
void test_uint16_overflow_in_elements(void)
{
    ...
    expected_sum_u32 = (uint32_t)((uint16_t)(40000U * 2U)) +
                       (uint32_t)((uint16_t)(50000U * 2U)) +
                       (uint32_t)((uint16_t)(60000U * 2U));
