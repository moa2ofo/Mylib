# 0 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State1_RecordValue0Delta0_VerifyAdjustedComputed/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State1_RecordValue0Delta0_VerifyAdjustedComputed/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State1_RecordValue0Delta0_VerifyAdjustedComputed/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b =
# 11 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 3 4
      0
# 11 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
      ;
...
# 31 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 3 4
                                  ((void *)0)
# 31 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
                                      ,
                                  (5U));
  MyLib_ProcessRecord_CMockIgnoreArg_rec_pc(32);

  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(34, 0U, &delta, computed);

  result = MyLib_RunStateMachine_u8(
# 36 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 3 4
      ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
          ,
      0U, &delta);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((0U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 38 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 3 4
                             ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
                                 ),
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((computed)), (UNITY_INT)(UNITY_UINT32)((MyLib_RunStateMachine_u8_GetLastAdjusted_u32())),
                         (
# 39 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c" 3 4
                             ((void *)0)
# 39 "utExecutionAndResults/utUnderTest/test/test_State1_RecordValue0Delta0_VerifyAdjustedComputed.c"
                                 ),
