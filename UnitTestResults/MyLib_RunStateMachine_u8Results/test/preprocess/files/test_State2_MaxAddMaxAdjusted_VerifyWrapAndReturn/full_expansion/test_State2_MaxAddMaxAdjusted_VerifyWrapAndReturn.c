# 0 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b = 
# 11 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
                   0
# 11 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
                        ;
...
# 24 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
                             (4294967295U) 
# 24 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
                                        - 1U;

  MyLib_RunStateMachine_u8_SetState_u8(2U);
  MyLib_RunStateMachine_u8_SetLastAdjusted_u32(
# 27 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
                                              (4294967295U)
# 27 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
                                                        );

  MyLib_UpdateCounter_u8_CMockExpectAndReturn(29, expected_wrapped, 1U);

  result = MyLib_RunStateMachine_u8(
# 31 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
                                   ((void *)0)
# 31 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
                                       , 
# 31 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
                                         (4294967295U)
# 31 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
...
# 33 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
...
# 34 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_State2_MaxAddMaxAdjusted_VerifyWrapAndReturn.c"
