# 0 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CycleToggle_FromDisabledToEnabled/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CycleToggle_FromDisabledToEnabled/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CycleToggle_FromDisabledToEnabled/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 2
...
# 10 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
void setUp(void) {

  g_counter_u32 = 0U;
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
                        ;
  g_record.id_u16 = 0U;
  ...
  SetSaturationEn_b(
# 19 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
                   1
# 19 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
                       );
}
...
void test_MyLib_UpdateCounter_u8_CycleToggle_FromDisabledToEnabled(void) {
  ...
  g_systemReady_b = 
# 29 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
                   1
# 29 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
                       ;
  SetSaturationEn_b(
# 30 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
                   0
# 30 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
                        );
  SetCounterLimit_u32(100U);
  g_counter_u32 = 0U;
...
# 37 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
   ((void *)0)
# 37 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
   ), (UNITY_UINT)(37), UNITY_DISPLAY_STYLE_UINT8);
    UnityAssertEqualNumber((UNITY_INT)((
# 38 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
   0
# 38 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
...
# 38 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
  ...
  result = MyLib_UpdateCounter_u8(1U);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0U)), (UNITY_INT)(UNITY_UINT8 )((result)), (
# 43 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
 ((void *)0)
# 43 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
 ), (UNITY_UINT)(43), UNITY_DISPLAY_STYLE_UINT8);


  UnityAssertEqualNumber((UNITY_INT)((
# 46 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
 1
# 46 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
 )), (UNITY_INT)((GetSaturationEn_b())), (
# 46 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c" 3 4
 ((void *)0)
# 46 "utExecutionAndResults/utUnderTest/test/test_CycleToggle_FromDisabledToEnabled.c"
