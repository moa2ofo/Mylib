...
# 17 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
...
void setUp(void) {
  ...
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 20 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 3 4
                   0
# 20 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
                        ;


  set_CounterLimit_u32(0U);
  set_SaturationEn_b(
# 24 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 3 4
                    0
# 24 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
                         );
}
