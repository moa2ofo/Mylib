# 0 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_sat_disabled_add_small_returns_0/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_sat_disabled_add_small_returns_0/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"

# 17 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
                        ;
  SetCounterLimit_u32(0U);
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
                        );
}
...
void test_ready_sat_disabled_add_small_returns_0(void) {
  ...
  g_systemReady_b = 
# 30 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 3 4
                   1
# 30 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
                       ;
  g_counter_u32 = 10U;
  SetSaturationEn_b(
# 32 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 3 4
                   0
# 32 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
                        );
...
# 37 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 3 4
 ((void *)0)
# 37 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
 ), (UNITY_UINT)(37), UNITY_DISPLAY_STYLE_UINT8);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((25U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 38 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c" 3 4
 ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_ready_sat_disabled_add_small_returns_0.c"
