# 0 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_toggle_after_32_calls/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_toggle_after_32_calls/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"

# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
                        ;
  SetCounterLimit_u32(0U);
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
                        );
}
...
# 29 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
 _Bool 
# 29 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
      initial_sat;
  
# 30 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
 _Bool 
# 30 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
      after_16_sat;
  
# 31 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
 _Bool 
# 31 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
      after_32_sat;

  g_systemReady_b = 
# 33 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
                   1
# 33 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
                       ;
  g_counter_u32 = 0U;
  SetSaturationEn_b(
# 35 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
                   0
# 35 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
                        );
  ...
  do { if (((initial_sat) != (after_16_sat))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((45))); } } while (0);
...
# 51 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
 ((void *)0)
# 51 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
 ), (UNITY_UINT)(51), UNITY_DISPLAY_STYLE_INT);

  MyLib_UpdateCounter_u8(1U);

  after_32_sat = GetSaturationEn_b();
  do { if (((after_16_sat) != (after_32_sat))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((56))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)((initial_sat)), (UNITY_INT)((after_32_sat)), (
# 57 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c" 3 4
 ((void *)0)
# 57 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_32_calls.c"
