# 0 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiple_calls_sequence_toggle_intervals/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiple_calls_sequence_toggle_intervals/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
...
void setUp(void) {
  ...
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 20 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 3 4
                   0
# 20 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
                        ;


  set_CounterLimit_u32(0U);
  set_SaturationEn_b(
# 24 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 3 4
                    0
# 24 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
                         );
}
...
void test_MyLib_UpdateCounter_u8_multiple_calls_sequence_toggle_intervals(void) {
  ...
  g_systemReady_b = 
# 37 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 3 4
                   1
# 37 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
                       ;
  g_counter_u32 = 0U;
  set_SaturationEn_b(
# 39 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 3 4
                    0
# 39 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
                         );
  ...
  for(i = 1U; i <= 48U; i++) {
    ...
    if((i % 16U) == 0U) {
      ...
      do { if (((saturation_state_b) != (get_SaturationEn_b()))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((49))); } } while (0);
    }
  }


  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((48U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 54 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 3 4
 ((void *)0)
# 54 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
 ), (UNITY_UINT)(54), UNITY_DISPLAY_STYLE_UINT32);


  UnityAssertEqualNumber((UNITY_INT)((
# 57 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c" 3 4
 0
# 57 "utExecutionAndResults/utUnderTest/test/test_multiple_calls_sequence_toggle_intervals.c"
