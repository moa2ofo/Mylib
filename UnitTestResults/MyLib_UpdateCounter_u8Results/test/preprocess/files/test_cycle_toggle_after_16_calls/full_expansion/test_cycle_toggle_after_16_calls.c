# 0 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_toggle_after_16_calls/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_toggle_after_16_calls/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"

# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
                        ;
  SetCounterLimit_u32(0U);
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
                        );
}
...
# 29 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
 _Bool 
# 29 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
      initial_sat;
  
# 30 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
 _Bool 
# 30 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
      final_sat;

  g_systemReady_b = 
# 32 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
                   1
# 32 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
                       ;
  g_counter_u32 = 0U;
  SetSaturationEn_b(
# 34 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
                   0
# 34 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
                        );
...
# 43 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c" 3 4
 ((void *)0)
# 43 "utExecutionAndResults/utUnderTest/test/test_cycle_toggle_after_16_calls.c"
 ), (UNITY_UINT)(43), UNITY_DISPLAY_STYLE_INT);

  MyLib_UpdateCounter_u8(1U);

  final_sat = GetSaturationEn_b();
  do { if (((initial_sat) != (final_sat))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((48))); } } while (0);
}
