# 0 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
...
void setUp(void) {
  ...
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 20 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 3 4
                   0
# 20 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
                        ;


  set_CounterLimit_u32(0U);
  set_SaturationEn_b(
# 24 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 3 4
                    0
# 24 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
                         );
}
...
void test_MyLib_UpdateCounter_u8_ready_saturation_enabled_new_one_above_limit_returns_2_clamped(void) {
  ...
  g_systemReady_b = 
# 34 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 3 4
                   1
# 34 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
                       ;
  g_counter_u32 = 90U;
  set_SaturationEn_b(
# 36 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 3 4
                    1
# 36 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
                        );
...
# 41 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 3 4
 ((void *)0)
# 41 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
...
# 42 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c" 3 4
 ((void *)0)
# 42 "utExecutionAndResults/utUnderTest/test/test_ready_saturation_enabled_new_one_above_limit_returns_2_clamped.c"
