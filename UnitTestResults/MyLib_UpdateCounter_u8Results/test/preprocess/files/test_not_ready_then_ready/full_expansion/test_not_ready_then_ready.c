# 0 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_not_ready_then_ready/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_not_ready_then_ready/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"

# 17 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
                        ;
  SetCounterLimit_u32(0U);
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
                        );
}
...
void test_not_ready_then_ready(void) {
  ...
  g_systemReady_b = 
# 31 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
                   0
# 31 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
                        ;
  g_counter_u32 = 10U;
  SetSaturationEn_b(
# 33 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
                   0
# 33 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
                        );
...
# 37 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
 ((void *)0)
# 37 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
...
# 38 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
 ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
 ), (UNITY_UINT)(38), UNITY_DISPLAY_STYLE_UINT32);

  g_systemReady_b = 
# 40 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
                   1
# 40 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
                       ;

  result2 = MyLib_UpdateCounter_u8(5U);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0U)), (UNITY_INT)(UNITY_UINT8 )((result2)), (
# 43 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
 ((void *)0)
# 43 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
...
# 44 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c" 3 4
 ((void *)0)
# 44 "utExecutionAndResults/utUnderTest/test/test_not_ready_then_ready.c"
