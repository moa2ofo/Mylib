# 0 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CycleCountToggle_FindPattern/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CycleCountToggle_FindPattern/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CycleCountToggle_FindPattern/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 2
...
# 10 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
void setUp(void) {

  g_counter_u32 = 0U;
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
                        ;
  g_record.id_u16 = 0U;
  ...
  SetSaturationEn_b(
# 19 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                   1
# 19 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
                       );
}
...
# 27 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
 _Bool 
# 27 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
      saturation_state;
  
# 28 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
 _Bool 
# 28 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
      first_toggle_found = 
# 28 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                           0
# 28 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
  ...
  g_systemReady_b = 
# 32 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                   1
# 32 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
                       ;
  SetSaturationEn_b(
# 33 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                   1
# 33 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
                       );
  SetCounterLimit_u32(100U);
  g_counter_u32 = 0U;
...
# 41 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
   ((void *)0)
# 41 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
   ), (UNITY_UINT)(41), UNITY_DISPLAY_STYLE_UINT8);

    
# 43 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
   _Bool 
# 43 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
        current_state = GetSaturationEn_b();
    if(current_state != saturation_state) {
      first_toggle_found = 
# 45 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                          1
# 45 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
                              ;
  ...
  do { if ((first_toggle_found)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((52))); } } while (0);


  saturation_state = GetSaturationEn_b();
  
# 56 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
 _Bool 
# 56 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
      second_toggle_found = 
# 56 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                            0
# 56 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
  ...
  for(int i = 0; i < 16; i++) {
    result = MyLib_UpdateCounter_u8(1U);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0U)), (UNITY_INT)(UNITY_UINT8 )((result)), (
# 60 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
   ((void *)0)
# 60 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
   ), (UNITY_UINT)(60), UNITY_DISPLAY_STYLE_UINT8);

    
# 62 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
   _Bool 
# 62 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
        current_state = GetSaturationEn_b();
    if(current_state != saturation_state) {
      second_toggle_found = 
# 64 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c" 3 4
                           1
# 64 "utExecutionAndResults/utUnderTest/test/test_CycleCountToggle_FindPattern.c"
                               ;
      break;
    }
  }
  ...
  do { if ((second_toggle_found)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((70))); } } while (0);
}
