# 0 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_counter_persistence_increments_all_paths/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_counter_persistence_increments_all_paths/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
...
void setUp(void) {
  ...
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 20 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
                   0
# 20 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
                        ;


  set_CounterLimit_u32(0U);
  set_SaturationEn_b(
# 24 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
                    0
# 24 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
                         );
}
...
# 33 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
 _Bool 
# 33 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
      initial_saturation_b;
  
# 34 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
 _Bool 
# 34 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
      final_saturation_b;

  g_systemReady_b = 
# 36 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
                   0
# 36 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
                        ;
  g_counter_u32 = 0U;
  set_SaturationEn_b(
# 38 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
                    0
# 38 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
                         );
  ...
  g_systemReady_b = 
# 47 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c" 3 4
                   1
# 47 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence_increments_all_paths.c"
                       ;
  ...
  do { if (((initial_saturation_b) != (final_saturation_b))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((55))); } } while (0);
}
