# 0 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_system_not_ready_returns_1/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_system_not_ready_returns_1/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"

# 17 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
                        ;
  SetCounterLimit_u32(0U);
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
                        );
}
...
void test_system_not_ready_returns_1(void) {
  ...
  g_systemReady_b = 
# 30 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 3 4
                   0
# 30 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
                        ;
  g_counter_u32 = 10U;
...
# 35 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 3 4
 ((void *)0)
# 35 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
...
# 36 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c" 3 4
 ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1.c"
