# 0 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_SystemReady_NormalAdd_ReturnZero/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_SystemReady_NormalAdd_ReturnZero/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_SystemReady_NormalAdd_ReturnZero/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 2
...
# 10 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
void setUp(void) {

  g_counter_u32 = 0U;
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
                        ;
  g_record.id_u16 = 0U;
  ...
  SetSaturationEn_b(
# 19 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 3 4
                   1
# 19 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
                       );
}
...
void test_MyLib_UpdateCounter_u8_SystemReady_NormalAdd_ReturnZero(void) {
  ...
  g_systemReady_b = 
# 29 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 3 4
                   1
# 29 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
                       ;
  SetSaturationEn_b(
# 30 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 3 4
                   1
# 30 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
                       );
  SetCounterLimit_u32((100U));
  g_counter_u32 = 10U;
...
# 38 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 3 4
 ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
...
# 41 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c" 3 4
 ((void *)0)
# 41 "utExecutionAndResults/utUnderTest/test/test_SystemReady_NormalAdd_ReturnZero.c"
