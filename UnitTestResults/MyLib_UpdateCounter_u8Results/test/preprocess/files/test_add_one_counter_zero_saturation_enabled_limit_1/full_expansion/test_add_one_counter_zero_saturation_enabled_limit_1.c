# 0 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_add_one_counter_zero_saturation_enabled_limit_1/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_add_one_counter_zero_saturation_enabled_limit_1/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_add_one_counter_zero_saturation_enabled_limit_1/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 2


# 6 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
```c
...
static 
# 11 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
      _Bool 
# 11 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
           s_saturationEn_b;
...
# 21 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
_Bool 
# 21 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
    GetSaturationEn_b(void) {
  return s_saturationEn_b;
}

void SetSaturationEn_b(
# 25 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
                      _Bool 
# 25 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
                           enable) {
...
void setUp(void) {
  ...
  s_saturationEn_b = 
# 32 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
                    0
# 32 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
                         ;
}
...
void test_add_one_counter_zero_saturation_enabled_limit_1(void) {
  ...
  SetSaturationEn_b(
# 43 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
                   1
# 43 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
                       );

  result = MyLib_UpdateCounter_u8(1U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 47 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
 ((void *)0)
# 47 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
 ), (UNITY_UINT)(47), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((1U)), (UNITY_INT)(UNITY_UINT8 )((result)), (
# 48 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c" 3 4
 ((void *)0)
# 48 "utExecutionAndResults/utUnderTest/test/test_add_one_counter_zero_saturation_enabled_limit_1.c"
