...
# 3 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 2
...
# 19 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c"
  ...
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c"
                        );
}
...
void test_ready_sat_enabled_equals_limit_returns_0(void) {
  ...
  g_systemReady_b = 
# 30 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 3 4
                   1
# 30 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c"
                       ;
  g_counter_u32 = 80U;
  SetSaturationEn_b(
# 32 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 3 4
                   1
# 32 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c"
                       );
...
# 37 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 3 4
 ((void *)0)
# 37 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c"
...
# 38 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c" 3 4
 ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_equals_limit_returns_0.c"
