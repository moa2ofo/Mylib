# 0 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CounterAtZero_WithAddition/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CounterAtZero_WithAddition/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_CounterAtZero_WithAddition/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 2
...
# 10 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
void setUp(void) {

  g_counter_u32 = 0U;
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
                        ;
  g_record.id_u16 = 0U;
  ...
  SetSaturationEn_b(
# 19 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 3 4
                   1
# 19 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
                       );
}
...
void test_MyLib_UpdateCounter_u8_CounterAtZero_WithAddition(void) {
  ...
  g_systemReady_b = 
# 29 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 3 4
                   1
# 29 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
                       ;
  SetSaturationEn_b(
# 30 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 3 4
                   1
# 30 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
                       );
  g_counter_u32 = 0U;
...
# 37 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 3 4
 ((void *)0)
# 37 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
...
# 40 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c" 3 4
 ((void *)0)
# 40 "utExecutionAndResults/utUnderTest/test/test_CounterAtZero_WithAddition.c"
