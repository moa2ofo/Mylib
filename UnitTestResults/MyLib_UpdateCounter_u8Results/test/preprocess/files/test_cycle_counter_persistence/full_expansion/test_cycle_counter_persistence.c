# 0 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_counter_persistence/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_cycle_counter_persistence/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 2
# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"

# 17 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
                        ;
  SetCounterLimit_u32(0U);
  SetSaturationEn_b(
# 21 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 3 4
                   0
# 21 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
                        );
}
...
void test_cycle_counter_persistence(void) {
  ...
  g_systemReady_b = 
# 30 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 3 4
                   1
# 30 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
                       ;
  g_counter_u32 = 0U;
  SetSaturationEn_b(
# 32 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 3 4
                   0
# 32 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
                        );
...
# 39 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 3 4
 _Bool 
# 39 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
...
# 45 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c" 3 4
 _Bool 
# 45 "utExecutionAndResults/utUnderTest/test/test_cycle_counter_persistence.c"
      sat_after_32 = GetSaturationEn_b();

  do { if (((sat_after_16) != (sat_after_32))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((47))); } } while (0);
}
