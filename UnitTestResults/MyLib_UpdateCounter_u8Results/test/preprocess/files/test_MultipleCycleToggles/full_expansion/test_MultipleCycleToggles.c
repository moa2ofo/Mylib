# 0 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_MultipleCycleToggles/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_MultipleCycleToggles/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_MultipleCycleToggles/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 2
...
# 10 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
void setUp(void) {

  g_counter_u32 = 0U;
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
                        ;
  g_record.id_u16 = 0U;
  ...
  SetSaturationEn_b(
# 19 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
                   1
# 19 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
                       );
}
...
# 27 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
 _Bool 
# 27 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
      saturation_state;
  int toggle_count = 0;


  g_systemReady_b = 
# 31 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
                   1
# 31 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
                       ;
  SetSaturationEn_b(
# 32 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
                   1
# 32 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
                       );
  SetCounterLimit_u32(100U);
  g_counter_u32 = 0U;
...
# 41 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
   ((void *)0)
# 41 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
   ), (UNITY_UINT)(41), UNITY_DISPLAY_STYLE_UINT8);

    
# 43 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
   _Bool 
# 43 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
...
# 51 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
 ((void *)0)
# 51 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
...
# 52 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
 ((void *)0)
# 52 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
 ), (UNITY_UINT)(52), UNITY_DISPLAY_STYLE_INT);


  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((48U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 55 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c" 3 4
 ((void *)0)
# 55 "utExecutionAndResults/utUnderTest/test/test_MultipleCycleToggles.c"
