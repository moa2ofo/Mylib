...
void setUp(void) {
  ...
  captured_record_ptr = 
# 34 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c" 3 4
                       ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c"
                           ;
...
# 50 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c" 3 4
                                            ((void *)0)
# 50 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c"
                                                );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((MyLib_ProcessRecord_call_count)), (
# 52 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c" 3 4
 ((void *)0)
# 52 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c"
 ), (UNITY_UINT)(52), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((((captured_record_ptr)) != 
# 53 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c" 3 4
 ((void *)0)
# 53 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c"
...
# 54 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c" 3 4
 ((void *)0)
# 54 "utExecutionAndResults/utUnderTest/test/test_record_value_odd_base.c"
