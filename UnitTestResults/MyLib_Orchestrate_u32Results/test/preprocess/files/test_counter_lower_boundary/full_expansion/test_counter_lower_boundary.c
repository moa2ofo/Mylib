# 0 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_counter_lower_boundary/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_counter_lower_boundary/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_counter_lower_boundary/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c" 2
...
void setUp(void) {
  ...
  captured_record_ptr = 
# 34 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c" 3 4
                       ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c"
                           ;
...
# 50 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c" 3 4
                                              ((void *)0)
# 50 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c"
                                                  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((150)), (UNITY_INT)(UNITY_UINT32)((result)), (
# 52 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c" 3 4
 ((void *)0)
# 52 "utExecutionAndResults/utUnderTest/test/test_counter_lower_boundary.c"
