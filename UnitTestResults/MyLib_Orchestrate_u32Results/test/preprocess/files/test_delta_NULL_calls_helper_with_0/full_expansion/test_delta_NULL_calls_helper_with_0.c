# 0 "utExecutionAndResults/utUnderTest/test/test_delta_NULL_calls_helper_with_0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_delta_NULL_calls_helper_with_0.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_delta_NULL_calls_helper_with_0.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_delta_NULL_calls_helper_with_0/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_delta_NULL_calls_helper_with_0/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_delta_NULL_calls_helper_with_0/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_delta_NULL_calls_helper_with_0.c" 2
...
void test_delta_NULL_calls_helper_with_0(void) {
  ...
  InternalHelper_u32_CMockExpectAndReturn(47, 50, 0, 100);
  MyLib_ProcessRecord_Stub(MyLib_ProcessRecord_Callback);

  MyLib_Orchestrate_u32(50, 
# 50 "utExecutionAndResults/utUnderTest/test/test_delta_NULL_calls_helper_with_0.c" 3 4
                           ((void *)0)
# 50 "utExecutionAndResults/utUnderTest/test/test_delta_NULL_calls_helper_with_0.c"
                               );
}
