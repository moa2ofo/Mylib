...
# 47 "utExecutionAndResults/utUnderTest/test/test_start_1_delta_NULL.c" 3 4
                                            ((void *)0)
# 47 "utExecutionAndResults/utUnderTest/test/test_start_1_delta_NULL.c"
                                                );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((150)), (UNITY_INT)(UNITY_UINT32)((result)), (
# 49 "utExecutionAndResults/utUnderTest/test/test_start_1_delta_NULL.c" 3 4
 ((void *)0)
# 49 "utExecutionAndResults/utUnderTest/test/test_start_1_delta_NULL.c"
