# 0 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_id_lower_16bits/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_id_lower_16bits/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_id_lower_16bits/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 2
...
void setUp(void) {
  ...
  captured_record_ptr = 
# 34 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
                       ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
                           ;
...
# 50 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
                                              ((void *)0)
# 50 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
                                                  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((MyLib_ProcessRecord_call_count)), (
# 52 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
 ((void *)0)
# 52 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
 ), (UNITY_UINT)(52), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((((captured_record_ptr)) != 
# 53 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
 ((void *)0)
# 53 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
 )) { } else { UnityFail( (((" Expected Non-NULL"))), (UNITY_UINT)(((53)))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0x5678)), (UNITY_INT)(UNITY_UINT16)((captured_record_ptr->id_u16)), (
# 54 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
 ((void *)0)
# 54 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
