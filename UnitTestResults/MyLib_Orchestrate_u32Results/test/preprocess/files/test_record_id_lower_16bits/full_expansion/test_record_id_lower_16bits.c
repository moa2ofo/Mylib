...
# 47 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
                          ((void *)0)
# 47 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
                              );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0x5678)), (UNITY_INT)(UNITY_UINT16)((captured_record.id_u16)), (
# 49 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c" 3 4
 ((void *)0)
# 49 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16bits.c"
