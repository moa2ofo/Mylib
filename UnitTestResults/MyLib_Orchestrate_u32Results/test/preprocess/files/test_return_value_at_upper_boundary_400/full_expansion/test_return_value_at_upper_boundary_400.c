# 0 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_return_value_at_upper_boundary_400/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_return_value_at_upper_boundary_400/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_return_value_at_upper_boundary_400/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b =
# 13 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c" 3 4
      0
# 13 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c"
      ;
}
...
# 21 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c" 3 4
      ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c"
      ;
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expected_return)), (UNITY_INT)(UNITY_UINT32)((actual_return)),
                         (
# 41 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c" 3 4
                             ((void *)0)
# 41 "utExecutionAndResults/utUnderTest/test/test_return_value_at_upper_boundary_400.c"
                                 ),
