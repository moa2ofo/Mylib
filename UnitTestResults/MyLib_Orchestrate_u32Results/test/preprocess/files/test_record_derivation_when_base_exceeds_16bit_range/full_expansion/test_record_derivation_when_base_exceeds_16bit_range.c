# 0 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_derivation_when_base_exceeds_16bit_range/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_derivation_when_base_exceeds_16bit_range/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_derivation_when_base_exceeds_16bit_range/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b =
# 13 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c" 3 4
      0
# 13 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c"
      ;
}
...
void test_record_derivation_when_base_exceeds_16bit_range(void) {
  ...
  InternalHelper_u32_CMockExpectAndReturn(29, start_u32, delta_value, l_base_u32);
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_base_u32 + g_counter_u32)), (UNITY_INT)(UNITY_UINT32)((actual_return)),
                         (
# 39 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c" 3 4
                             ((void *)0)
# 39 "utExecutionAndResults/utUnderTest/test/test_record_derivation_when_base_exceeds_16bit_range.c"
                                 ),
