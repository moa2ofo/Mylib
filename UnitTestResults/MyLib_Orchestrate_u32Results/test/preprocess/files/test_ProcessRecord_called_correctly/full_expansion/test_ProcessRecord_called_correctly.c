# 0 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ProcessRecord_called_correctly/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ProcessRecord_called_correctly/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ProcessRecord_called_correctly/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 2
...
void setUp(void) {
  ...
  captured_record_ptr = 
# 34 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 3 4
                       ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
                           ;
...
void test_ProcessRecord_called_correctly(void) {
  ...
  uint32_t result = MyLib_Orchestrate_u32(50, 
# 50 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 3 4
                                             ((void *)0)
# 50 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
                                                 );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((MyLib_ProcessRecord_call_count)), (
# 52 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 3 4
 ((void *)0)
# 52 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
 ), (UNITY_UINT)(52), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((((captured_record_ptr)) != 
# 53 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 3 4
 ((void *)0)
# 53 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
 )) { } else { UnityFail( (((" Expected Non-NULL"))), (UNITY_UINT)(((53)))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )(((5U))), (UNITY_INT)(UNITY_UINT8 )((captured_multiplier)), (
# 54 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c" 3 4
 ((void *)0)
# 54 "utExecutionAndResults/utUnderTest/test/test_ProcessRecord_called_correctly.c"
