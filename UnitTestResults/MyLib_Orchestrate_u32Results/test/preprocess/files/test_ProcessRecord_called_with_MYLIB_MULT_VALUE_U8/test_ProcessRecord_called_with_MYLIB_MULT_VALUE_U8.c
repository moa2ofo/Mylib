...
void test_ProcessRecord_called_with_MYLIB_MULT_VALUE_U8(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_base_u32 + g_counter_u32)), (UNITY_INT)(UNITY_UINT32)((actual_return)), (((void *)0)), (UNITY_UINT)(33), UNITY_DISPLAY_STYLE_UINT32);
}