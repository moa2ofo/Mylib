# 0 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c"
...
# 7 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta/mock_MyLib.h" 2
...
# 8 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c" 2
# 21 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c"
void setUp(void) {
  ...
  g_systemReady_b = 
# 26 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c" 3 4
                   0
# 26 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c"
                        ;
}
...
# 43 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c" 3 4
 ((void *)0)
# 43 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c"
 , (5U));
...
# 52 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c" 3 4
 ((void *)0)
# 52 "utExecutionAndResults/utUnderTest/test/test_WhenDeltaIsNotNullAndStartIsNonZero_UsesCorrectDelta.c"
