...
void test_MyLib_ComputeAdjustedValue_u32_base_599_delta_NULL(void) {
  ...
  result_u32 = MyLib_ComputeAdjustedValue_u32(599U, 
# 32 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c" 3 4
                                                   ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c"
                                                       );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expected_result_u32)), (UNITY_INT)(UNITY_UINT32)((result_u32)), (
# 34 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c"
