...
void setUp(void) {
  ...
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_base_1_delta_1.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_base_1_delta_1.c"
                        ;
}
...
void test_MyLib_ComputeAdjustedValue_u32_base_1_delta_1(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_expected_u32)), (UNITY_INT)(UNITY_UINT32)((MyLib_ComputeAdjustedValue_u32(1U, &l_delta_u16))), (
# 29 "utExecutionAndResults/utUnderTest/test/test_base_1_delta_1.c" 3 4
 ((void *)0)
# 29 "utExecutionAndResults/utUnderTest/test/test_base_1_delta_1.c"
