...
void setUp(void) {
  ...
  g_systemReady_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c" 3 4
                   0
# 13 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c"
                        ;
}
...
void test_MyLib_ComputeAdjustedValue_u32_base_0_delta_NULL(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_expected_u32)), (UNITY_INT)(UNITY_UINT32)((MyLib_ComputeAdjustedValue_u32(0U, 
# 28 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c"
 ))), (
# 28 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c"
