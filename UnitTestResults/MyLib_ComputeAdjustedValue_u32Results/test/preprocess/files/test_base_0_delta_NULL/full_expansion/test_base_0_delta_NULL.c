...
# 33 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c" 3 4
                                                 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c"
                                                     );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expected_result_u32)), (UNITY_INT)(UNITY_UINT32)((result_u32)), (
# 35 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c" 3 4
 ((void *)0)
# 35 "utExecutionAndResults/utUnderTest/test/test_base_0_delta_NULL.c"
