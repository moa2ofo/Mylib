...
# 9 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c"
...
void test_overflow_handling(void) {
  for(size_t i = 0; i < 10; i++) {
    test_array[i] = 
# 22 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c" 3 4
                   (65535)
# 22 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c"
                             ;
  }
  uint32_t result = MyLib_AnalyzeArray_u32(test_array, 10, 
# 24 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c" 3 4
                                                          (65535)
# 24 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c"
                                                                    );
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((
# 25 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c" 3 4
 (4294967295U)
# 25 "utExecutionAndResults/utUnderTest/test/test_overflow_handling.c"
