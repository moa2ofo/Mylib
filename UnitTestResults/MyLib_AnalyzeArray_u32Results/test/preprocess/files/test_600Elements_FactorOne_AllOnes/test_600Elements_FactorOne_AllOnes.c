...
void test_600Elements_FactorOne_AllOnes(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(30, 600U, ((void *)0), 0U);

  result = MyLib_AnalyzeArray_u32(array, 600U, 1U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((600U)), (UNITY_INT)(UNITY_UINT32)((result)), (((void *)0)), (UNITY_UINT)(34), UNITY_DISPLAY_STYLE_UINT32);
  for(i = 0U; i < 600U; i++) {
