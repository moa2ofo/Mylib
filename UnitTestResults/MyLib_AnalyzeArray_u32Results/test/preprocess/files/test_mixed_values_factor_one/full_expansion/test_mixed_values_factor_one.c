...
# 9 "utExecutionAndResults/utUnderTest/test/test_mixed_values_factor_one.c"
...
void test_mixed_values_factor_one(void) {
  ...
  test_array[1] = 32768;
  test_array[2] = 
# 23 "utExecutionAndResults/utUnderTest/test/test_mixed_values_factor_one.c" 3 4
                 (65535)
# 23 "utExecutionAndResults/utUnderTest/test/test_mixed_values_factor_one.c"
                           ;
  uint32_t result = MyLib_AnalyzeArray_u32(test_array, 3, 1);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((98303)), (UNITY_INT)(UNITY_UINT32)((result)), (
# 25 "utExecutionAndResults/utUnderTest/test/test_mixed_values_factor_one.c" 3 4
 ((void *)0)
# 25 "utExecutionAndResults/utUnderTest/test/test_mixed_values_factor_one.c"
