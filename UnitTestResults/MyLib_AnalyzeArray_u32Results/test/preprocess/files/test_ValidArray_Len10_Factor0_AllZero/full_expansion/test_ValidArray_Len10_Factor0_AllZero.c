# 0 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ValidArray_Len10_Factor0_AllZero/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ValidArray_Len10_Factor0_AllZero/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ValidArray_Len10_Factor0_AllZero/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stddef.h" 1 3 4
# 6 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 2
...
# 8 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 2
# 19 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c"
...
# 32 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 3 4
 ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c"
 , 0);

  result = MyLib_AnalyzeArray_u32(array, 10, 0);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0)), (UNITY_INT)(UNITY_UINT32)((result)), (
# 36 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 3 4
 ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c"
 ), (UNITY_UINT)(36), UNITY_DISPLAY_STYLE_UINT32);
  for(i = 0; i < 10; i++) {
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0)), (UNITY_INT)(UNITY_UINT16)((array[i])), (
# 38 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c" 3 4
   ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_ValidArray_Len10_Factor0_AllZero.c"
