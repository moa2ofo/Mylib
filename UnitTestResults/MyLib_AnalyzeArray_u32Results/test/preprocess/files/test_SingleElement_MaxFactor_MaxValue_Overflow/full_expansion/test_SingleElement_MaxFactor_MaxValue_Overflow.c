# 0 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_SingleElement_MaxFactor_MaxValue_Overflow/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_SingleElement_MaxFactor_MaxValue_Overflow/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_SingleElement_MaxFactor_MaxValue_Overflow/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stddef.h" 1 3 4
# 6 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 2
...
# 8 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 2

# 11 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b =
# 15 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 3 4
      0
# 15 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
      ;
}
...
void test_SingleElement_MaxFactor_MaxValue_Overflow(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(26, (uint32_t)expected,
# 26 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 3 4
                                                      ((void *)0)
# 26 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
                                                          ,
                                                      0U);

  result = MyLib_AnalyzeArray_u32(array, 1U, 65535U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)(((uint32_t)expected)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 30 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 3 4
                             ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
                                 ),
                         (UNITY_UINT)(30), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((expected)), (UNITY_INT)(UNITY_UINT16)((array[0])),
                         (
# 31 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c" 3 4
                             ((void *)0)
# 31 "utExecutionAndResults/utUnderTest/test/test_SingleElement_MaxFactor_MaxValue_Overflow.c"
                                 ),
