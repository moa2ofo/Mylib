# 0 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullPointer_ZeroLen_ZeroFactor/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullPointer_ZeroLen_ZeroFactor/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullPointer_ZeroLen_ZeroFactor/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stddef.h" 1 3 4
# 6 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 2
...
# 8 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 2

# 11 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b =
# 15 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 3 4
      0
# 15 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c"
      ;
}
...
# 24 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 3 4
      ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c"
          ,
      0U, 0U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 26 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c" 3 4
                             ((void *)0)
# 26 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ZeroLen_ZeroFactor.c"
                                 ),
