...
# 9 "utExecutionAndResults/utUnderTest/test/test_ten_elem_factor_near_max.c"
...
void test_ten_elem_factor_near_max(void) {
  ...
  uint32_t result = MyLib_AnalyzeArray_u32(test_array, 10, 
# 24 "utExecutionAndResults/utUnderTest/test/test_ten_elem_factor_near_max.c" 3 4
                                                          (65535) 
# 24 "utExecutionAndResults/utUnderTest/test/test_ten_elem_factor_near_max.c"
                                                                     - 1);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((655340)), (UNITY_INT)(UNITY_UINT32)((result)), (
# 25 "utExecutionAndResults/utUnderTest/test/test_ten_elem_factor_near_max.c" 3 4
 ((void *)0)
# 25 "utExecutionAndResults/utUnderTest/test/test_ten_elem_factor_near_max.c"
