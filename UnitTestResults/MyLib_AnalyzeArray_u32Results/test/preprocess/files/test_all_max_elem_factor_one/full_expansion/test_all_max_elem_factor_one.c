...
# 9 "utExecutionAndResults/utUnderTest/test/test_all_max_elem_factor_one.c"
...
void test_all_max_elem_factor_one(void) {
  for(size_t i = 0; i < 10; i++) {
    test_array[i] = 
# 22 "utExecutionAndResults/utUnderTest/test/test_all_max_elem_factor_one.c" 3 4
                   (65535)
# 22 "utExecutionAndResults/utUnderTest/test/test_all_max_elem_factor_one.c"
                             ;
  }
  uint32_t result = MyLib_AnalyzeArray_u32(test_array, 10, 1);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((
# 25 "utExecutionAndResults/utUnderTest/test/test_all_max_elem_factor_one.c" 3 4
 (4294967295U)
# 25 "utExecutionAndResults/utUnderTest/test/test_all_max_elem_factor_one.c"
