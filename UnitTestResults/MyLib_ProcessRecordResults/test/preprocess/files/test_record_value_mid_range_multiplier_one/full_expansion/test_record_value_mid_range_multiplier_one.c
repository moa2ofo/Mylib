# 0 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_value_mid_range_multiplier_one/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_value_mid_range_multiplier_one/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_value_mid_range_multiplier_one/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c" 2
# 11 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 15 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c" 3 4
                   0
# 15 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c"
                        ;
}
...
void test_MyLib_ProcessRecord_record_value_mid_range_multiplier_one(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(29, 0x80000000U, (const uint16_t *)&(uint8_t){1U}, 0U);
  MyLib_ComputeAdjustedValue_u32_CMockIgnoreArg_delta_pc_u16(30);

  MyLib_ProcessRecord(&record, 1U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + 0x80000000U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 34 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_record_value_mid_range_multiplier_one.c"
