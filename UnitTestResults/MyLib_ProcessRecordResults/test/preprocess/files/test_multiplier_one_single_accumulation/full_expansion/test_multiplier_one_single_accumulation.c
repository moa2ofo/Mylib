...
# 11 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 15 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c" 3 4
                   0
# 15 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c"
                        ;
}
...
void test_MyLib_ProcessRecord_multiplier_one_single_accumulation(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(29, 75U, (const uint16_t *)&(uint8_t){1U}, 0U);
  MyLib_ComputeAdjustedValue_u32_CMockIgnoreArg_delta_pc_u16(30);

  MyLib_ProcessRecord(&record, 1U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + 75U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 34 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c"
