# 0 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c"
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_WrapAroundAccumulation/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_WrapAroundAccumulation/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c" 2
...
void test_MyLib_ProcessRecord_WrapAroundAccumulation(void) {
  ...
  g_counter_u32 = 
# 27 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c" 3 4
                 (4294967295U) 
# 27 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c"
                            - 100U;
  initial_counter = g_counter_u32;
...
# 35 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c" 3 4
                              (4294967295U) 
# 35 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c"
                                         - 100U) + 1000U;


  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(38, expected_accumulation, 
# 38 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c" 3 4
 ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c"
 , 0U);
...
# 45 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c" 3 4
 ((void *)0)
# 45 "utExecutionAndResults/utUnderTest/test/test_WrapAroundAccumulation.c"
