# 0 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c"
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullPointer_ReturnsWithoutSideEffects/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullPointer_ReturnsWithoutSideEffects/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c" 2
...
void test_MyLib_ProcessRecord_NullPointer_ReturnsWithoutSideEffects(void) {
  ...
  MyLib_ProcessRecord(
# 29 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c" 3 4
                     ((void *)0)
# 29 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c"
                         , 5U);


  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 32 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c" 3 4
 ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_NullPointer_ReturnsWithoutSideEffects.c"
