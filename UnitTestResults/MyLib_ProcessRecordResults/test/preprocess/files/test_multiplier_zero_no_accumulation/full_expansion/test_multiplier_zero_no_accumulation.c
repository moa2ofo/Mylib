...
# 11 "utExecutionAndResults/utUnderTest/test/test_multiplier_zero_no_accumulation.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 15 "utExecutionAndResults/utUnderTest/test/test_multiplier_zero_no_accumulation.c" 3 4
                   0
# 15 "utExecutionAndResults/utUnderTest/test/test_multiplier_zero_no_accumulation.c"
                        ;
}
...
# 34 "utExecutionAndResults/utUnderTest/test/test_multiplier_zero_no_accumulation.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_multiplier_zero_no_accumulation.c"
