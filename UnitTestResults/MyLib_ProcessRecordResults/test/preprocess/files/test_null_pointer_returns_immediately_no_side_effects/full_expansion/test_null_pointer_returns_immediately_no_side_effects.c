...
# 3 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c" 2
# 11 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 15 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c" 3 4
                   0
# 15 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c"
                        ;
}
...
void test_MyLib_ProcessRecord_null_pointer_returns_immediately_no_side_effects(void) {
  ...
  MyLib_ProcessRecord(
# 25 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c" 3 4
                     ((void *)0)
# 25 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c"
                         , 5U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 27 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c" 3 4
 ((void *)0)
# 27 "utExecutionAndResults/utUnderTest/test/test_null_pointer_returns_immediately_no_side_effects.c"
