# 0 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_rec_pc_NULL_returns_immediately_no_side_effects/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_rec_pc_NULL_returns_immediately_no_side_effects/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_rec_pc_NULL_returns_immediately_no_side_effects/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c"
                        ;
}
...
void test_MyLib_ProcessRecord_rec_pc_NULL_returns_immediately_no_side_effects(void) {
  ...
  MyLib_ProcessRecord(
# 28 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c" 3 4
                     ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c"
                         , 5U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (
# 30 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c" 3 4
 ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_rec_pc_NULL_returns_immediately_no_side_effects.c"
