...
void setUp(void) {
  ...
  g_systemReady_b = 
# 10 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c" 3 4
                   0
# 10 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c"
                        ;
}
