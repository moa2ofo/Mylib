# 0 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b = 
# 11 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c" 3 4
                   0
# 11 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c"
                        ;
}
...
# 27 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c" 3 4
 ((void *)0)
# 27 "utExecutionAndResults/utUnderTest/test/test__loop_counter_increments_correctly.c"
