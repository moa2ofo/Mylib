# 0 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b = 
# 11 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c" 3 4
                   0
# 11 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c"
                        ;
}
...
void test_InternalHelper_u32__does_not_modify_system_ready_flag(void) {
  ...
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c"
                        ;
  
# 20 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c" 3 4
 _Bool 
# 20 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c"
...
# 28 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test__does_not_modify_system_ready_flag.c"
 ), (UNITY_UINT)(28), UNITY_DISPLAY_STYLE_INT);
  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((29))); } } while (0);
}
