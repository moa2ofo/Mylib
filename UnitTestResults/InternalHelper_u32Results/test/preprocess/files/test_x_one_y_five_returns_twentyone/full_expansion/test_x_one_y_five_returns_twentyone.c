...
void setUp(void) {
  ...
  g_systemReady_b = 
# 10 "utExecutionAndResults/utUnderTest/test/test_x_one_y_five_returns_twentyone.c" 3 4
                   0
# 10 "utExecutionAndResults/utUnderTest/test/test_x_one_y_five_returns_twentyone.c"
                        ;
}
...
# 21 "utExecutionAndResults/utUnderTest/test/test_x_one_y_five_returns_twentyone.c" 3 4
 ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_x_one_y_five_returns_twentyone.c"
