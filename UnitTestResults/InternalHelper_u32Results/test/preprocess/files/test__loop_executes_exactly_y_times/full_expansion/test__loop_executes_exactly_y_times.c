# 0 "utExecutionAndResults/utUnderTest/test/test__loop_executes_exactly_y_times.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 3 "utExecutionAndResults/utUnderTest/test/test__loop_executes_exactly_y_times.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b = 
# 11 "utExecutionAndResults/utUnderTest/test/test__loop_executes_exactly_y_times.c" 3 4
                   0
# 11 "utExecutionAndResults/utUnderTest/test/test__loop_executes_exactly_y_times.c"
                        ;
}
...
# 28 "utExecutionAndResults/utUnderTest/test/test__loop_executes_exactly_y_times.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test__loop_executes_exactly_y_times.c"
