...
# 15 "utExecutionAndResults/utUnderTest/test/test_dest_valid_src_NULL_no_changes.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_dest_valid_src_NULL_no_changes.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_dest_valid_src_NULL_no_changes.c"
                        ;
}
...
# 33 "utExecutionAndResults/utUnderTest/test/test_dest_valid_src_NULL_no_changes.c" 3 4
 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_dest_valid_src_NULL_no_changes.c"
 ), (UNITY_UINT)(33), UNITY_DISPLAY_STYLE_UINT32);
  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((34))); } } while (0);
}
