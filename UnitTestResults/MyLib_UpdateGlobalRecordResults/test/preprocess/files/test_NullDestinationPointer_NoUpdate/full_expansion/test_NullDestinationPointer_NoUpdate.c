# 0 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullDestinationPointer_NoUpdate/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullDestinationPointer_NoUpdate/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
void setUp(void) {
  ...
  g_systemReady_b = 
# 20 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 3 4
                   0
# 20 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
                        ;
}
...
void test_MyLib_UpdateGlobalRecord_NullDestinationPointer_NoUpdate(void) {
  ...
  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((31))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)), (
# 32 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 3 4
 ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
...
# 33 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 3 4
 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
 ), (UNITY_UINT)(33), UNITY_DISPLAY_STYLE_UINT32);


  MyLib_UpdateGlobalRecord(
# 36 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 3 4
                          ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
                              , &source);


  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((39))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)), (
# 40 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 3 4
 ((void *)0)
# 40 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
 ), (UNITY_UINT)(40), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((g_record.value_u32)), (
# 41 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c" 3 4
 ((void *)0)
# 41 "utExecutionAndResults/utUnderTest/test/test_NullDestinationPointer_NoUpdate.c"
