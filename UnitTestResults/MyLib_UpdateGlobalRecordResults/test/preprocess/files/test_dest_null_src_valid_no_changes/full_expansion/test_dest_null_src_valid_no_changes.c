# 0 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_dest_null_src_valid_no_changes/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_dest_null_src_valid_no_changes/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_dest_null_src_valid_no_changes/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b = 
# 14 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 3 4
                   0
# 14 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
                        ;
}
...
# 23 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 3 4
 _Bool 
# 23 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
      initial_ready = g_systemReady_b;

  MyLib_UpdateGlobalRecord(
# 25 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 3 4
                          ((void *)0)
# 25 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
                              , &src);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((initial_record.id_u16)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)), (
# 27 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 3 4
 ((void *)0)
# 27 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
...
# 28 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
 ), (UNITY_UINT)(28), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)((initial_ready)), (UNITY_INT)((g_systemReady_b)), (
# 29 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c" 3 4
 ((void *)0)
# 29 "utExecutionAndResults/utUnderTest/test/test_dest_null_src_valid_no_changes.c"
