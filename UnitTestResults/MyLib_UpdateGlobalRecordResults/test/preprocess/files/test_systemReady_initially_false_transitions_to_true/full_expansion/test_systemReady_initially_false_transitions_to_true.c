# 0 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_initially_false_transitions_to_true/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_initially_false_transitions_to_true/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_initially_false_transitions_to_true/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 2
...
void setUp(void) {
  ...
  g_systemReady_b = 
# 14 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 3 4
                   0
# 14 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
                        ;
}
...
void test_MyLib_UpdateGlobalRecord_systemReady_initially_false_transitions_to_true(void) {
  ...
  g_systemReady_b = 
# 23 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 3 4
                   0
# 23 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
                        ;

  MyLib_UpdateGlobalRecord(&dest, &src);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((50U)), (UNITY_INT)(UNITY_UINT16)((dest.id_u16)), (
# 27 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 3 4
 ((void *)0)
# 27 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
...
# 28 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
...
# 29 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 3 4
 ((void *)0)
# 29 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
...
# 30 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c" 3 4
 ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_systemReady_initially_false_transitions_to_true.c"
