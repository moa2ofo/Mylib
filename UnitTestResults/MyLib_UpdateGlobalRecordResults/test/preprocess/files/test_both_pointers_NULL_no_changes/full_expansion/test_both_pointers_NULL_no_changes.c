...
# 15 "utExecutionAndResults/utUnderTest/test/test_both_pointers_NULL_no_changes.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_both_pointers_NULL_no_changes.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_both_pointers_NULL_no_changes.c"
                        ;
}
...
# 29 "utExecutionAndResults/utUnderTest/test/test_both_pointers_NULL_no_changes.c" 3 4
 ((void *)0)
# 29 "utExecutionAndResults/utUnderTest/test/test_both_pointers_NULL_no_changes.c"
 ), (UNITY_UINT)(29), UNITY_DISPLAY_STYLE_UINT32);
  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((30))); } } while (0);
}
