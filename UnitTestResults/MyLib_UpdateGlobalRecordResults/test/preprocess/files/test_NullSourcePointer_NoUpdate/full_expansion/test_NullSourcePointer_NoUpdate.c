# 0 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullSourcePointer_NoUpdate/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NullSourcePointer_NoUpdate/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
void setUp(void) {
  ...
  g_systemReady_b = 
# 20 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
                   0
# 20 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
                        ;
}
...
# 31 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
 ((void *)0)
# 31 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
...
# 32 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
 ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
 ), (UNITY_UINT)(32), UNITY_DISPLAY_STYLE_UINT32);
  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((33))); } } while (0);


  MyLib_UpdateGlobalRecord(&destination, 
# 36 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
                                        ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
                                            );


  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0x5555U)), (UNITY_INT)(UNITY_UINT16)((destination.id_u16)), (
# 39 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
 ((void *)0)
# 39 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
 ), (UNITY_UINT)(39), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0xAAAAAAAAU)), (UNITY_INT)(UNITY_UINT32)((destination.value_u32)), (
# 40 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
 ((void *)0)
# 40 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
 ), (UNITY_UINT)(40), UNITY_DISPLAY_STYLE_UINT32);


  do { if (!(g_systemReady_b)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((43))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)), (
# 44 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
 ((void *)0)
# 44 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
...
# 45 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c" 3 4
 ((void *)0)
# 45 "utExecutionAndResults/utUnderTest/test/test_NullSourcePointer_NoUpdate.c"
