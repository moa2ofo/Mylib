# 0 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_true_both_NULL_no_changes/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_true_both_NULL_no_changes/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_true_both_NULL_no_changes/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
                        ;
}
...
void test_MyLib_UpdateGlobalRecord_systemReady_true_both_NULL_no_changes(void) {
  g_systemReady_b = 
# 26 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 3 4
                   1
# 26 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
                       ;
  g_record.id_u16 = 123U;
  g_record.value_u32 = 456U;

  MyLib_UpdateGlobalRecord(
# 30 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 3 4
                          ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
                              , 
# 30 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 3 4
                                ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((123U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)), (
# 32 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 3 4
 ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
 ), (UNITY_UINT)(32), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((456U)), (UNITY_INT)(UNITY_UINT32)((g_record.value_u32)), (
# 33 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c" 3 4
 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_systemReady_true_both_NULL_no_changes.c"
 ), (UNITY_UINT)(33), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((g_systemReady_b)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((34))); } } while (0);
}
