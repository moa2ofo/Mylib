# 0 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_both_valid_just_inside_upper_boundary_updates_all/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_both_valid_just_inside_upper_boundary_updates_all/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_both_valid_just_inside_upper_boundary_updates_all/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
                        ;
}
...
void test_MyLib_UpdateGlobalRecord_both_valid_just_inside_upper_boundary_updates_all(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((65534U)), (UNITY_INT)(UNITY_UINT16)((dest.id_u16)), (
# 31 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 3 4
 ((void *)0)
# 31 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
 ), (UNITY_UINT)(31), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((4294967294U)), (UNITY_INT)(UNITY_UINT32)((dest.value_u32)), (
# 32 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 3 4
 ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
 ), (UNITY_UINT)(32), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((65534U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)), (
# 33 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 3 4
 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
 ), (UNITY_UINT)(33), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((4294967294U)), (UNITY_INT)(UNITY_UINT32)((g_record.value_u32)), (
# 34 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_both_valid_just_inside_upper_boundary_updates_all.c"
 ), (UNITY_UINT)(34), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((g_systemReady_b)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((35))); } } while (0);
}
