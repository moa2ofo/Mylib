# 0 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_false_valid_pointers_transitions_to_true/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_false_valid_pointers_transitions_to_true/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_systemReady_false_valid_pointers_transitions_to_true/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
void setUp(void) {
  g_counter_u32 = 0U;
  g_record.id_u16 = 0U;
  g_record.value_u32 = 0U;
  g_systemReady_b = 
# 19 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 3 4
                   0
# 19 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
                        ;
}
...
void test_MyLib_UpdateGlobalRecord_systemReady_false_valid_pointers_transitions_to_true(void) {
  ...
  g_systemReady_b = 
# 29 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 3 4
                   0
# 29 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
                        ;

  MyLib_UpdateGlobalRecord(&dest, &src);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((300U)), (UNITY_INT)(UNITY_UINT16)((dest.id_u16)), (
# 33 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 3 4
 ((void *)0)
# 33 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
...
# 34 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 3 4
 ((void *)0)
# 34 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
...
# 35 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 3 4
 ((void *)0)
# 35 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
...
# 36 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c" 3 4
 ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_systemReady_false_valid_pointers_transitions_to_true.c"
 ), (UNITY_UINT)(36), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((g_systemReady_b)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((37))); } } while (0);
}
