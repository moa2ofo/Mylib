# 0 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_sat_enabled_wrap_exceeds_limit_returns_2/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_sat_enabled_wrap_exceeds_limit_returns_2/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_ready_sat_enabled_wrap_exceeds_limit_returns_2/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c" 2
...
void test_ready_sat_enabled_wrap_exceeds_limit_returns_2(void) {
  ...
  g_systemReady_b =
# 17 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c" 3 4
      1
# 17 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c"
      ;
  g_counter_u32 = initial_counter;
  set_SaturationEn_b(
# 19 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c" 3 4
      1
# 19 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c"
  );
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((2U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 24 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c" 3 4
                             ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c"
                                 ),
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((limit)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 25 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c" 3 4
                             ((void *)0)
# 25 "utExecutionAndResults/utUnderTest/test/test_ready_sat_enabled_wrap_exceeds_limit_returns_2.c"
                                 ),
