...
void test_ready_add_max_minus_one_sat_disabled_returns_0(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + add_value)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (((void *)0)), (UNITY_UINT)(23), UNITY_DISPLAY_STYLE_UINT32);
}