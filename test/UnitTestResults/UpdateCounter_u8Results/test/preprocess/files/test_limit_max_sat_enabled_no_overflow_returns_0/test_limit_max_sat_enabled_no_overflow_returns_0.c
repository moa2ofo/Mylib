...
void test_limit_max_sat_enabled_no_overflow_returns_0(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + add_value)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (((void *)0)), (UNITY_UINT)(24), UNITY_DISPLAY_STYLE_UINT32);
}