# 0 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_limit_zero_sat_enabled_positive_add_returns_2/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_limit_zero_sat_enabled_positive_add_returns_2/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_limit_zero_sat_enabled_positive_add_returns_2/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c" 2
...
void test_limit_zero_sat_enabled_positive_add_returns_2(void) {
  ...
  g_systemReady_b =
# 14 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c" 3 4
      1
# 14 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c"
      ;
  g_counter_u32 = 0U;
  set_SaturationEn_b(
# 16 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c" 3 4
      1
# 16 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c"
  );
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((2U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 21 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c" 3 4
                             ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c"
                                 ),
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 22 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c" 3 4
                             ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_limit_zero_sat_enabled_positive_add_returns_2.c"
                                 ),
