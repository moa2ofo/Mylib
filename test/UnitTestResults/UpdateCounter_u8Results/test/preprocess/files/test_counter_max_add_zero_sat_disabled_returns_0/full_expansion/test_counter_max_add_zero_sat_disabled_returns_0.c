# 0 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_counter_max_add_zero_sat_disabled_returns_0/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_counter_max_add_zero_sat_disabled_returns_0/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_counter_max_add_zero_sat_disabled_returns_0/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c" 2
...
void test_counter_max_add_zero_sat_disabled_returns_0(void) {
  ...
  g_systemReady_b =
# 14 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c" 3 4
      1
# 14 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c"
      ;
  g_counter_u32 = 0xFFFFFFFFU;
  set_SaturationEn_b(
# 16 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c" 3 4
      0
# 16 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c"
  );
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((0U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 20 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c" 3 4
                             ((void *)0)
# 20 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c"
                                 ),
                         (UNITY_UINT)(20), UNITY_DISPLAY_STYLE_UINT8);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0xFFFFFFFFU)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 21 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c" 3 4
                             ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_counter_max_add_zero_sat_disabled_returns_0.c"
                                 ),
