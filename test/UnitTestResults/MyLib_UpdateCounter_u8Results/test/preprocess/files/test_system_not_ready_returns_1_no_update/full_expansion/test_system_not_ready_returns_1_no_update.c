# 0 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_system_not_ready_returns_1_no_update/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_system_not_ready_returns_1_no_update/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 2

# 7 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
void setUp(void) {
}
...
void test_system_not_ready_returns_1_no_update(void) {
  ...
  g_systemReady_b =
# 16 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 3 4
      0
# 16 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
      ;
  g_counter_u32 = 50U;
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((1U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 21 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 3 4
                             ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
                                 ),
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((50U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 22 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c" 3 4
                             ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_system_not_ready_returns_1_no_update.c"
                                 ),
