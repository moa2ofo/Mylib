# 0 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_max_add_from_zero_sat_off_returns_0/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_max_add_from_zero_sat_off_returns_0/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 2

# 7 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
void setUp(void) {
}
...
void test_max_add_from_zero_sat_off_returns_0(void) {
  ...
  g_systemReady_b =
# 16 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 3 4
      1
# 16 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
      ;
  g_counter_u32 = 0U;
  set_SaturationEn_b(
# 18 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 3 4
      0
# 18 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
  );

  result = MyLib_UpdateCounter_u8(
# 20 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 3 4
      (4294967295U)
# 20 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((0U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 22 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 3 4
                             ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
                                 ),
                         (UNITY_UINT)(22), UNITY_DISPLAY_STYLE_UINT8);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((
# 23 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c" 3 4
                             (4294967295U)
# 23 "utExecutionAndResults/utUnderTest/test/test_max_add_from_zero_sat_off_returns_0.c"
                                 )),
