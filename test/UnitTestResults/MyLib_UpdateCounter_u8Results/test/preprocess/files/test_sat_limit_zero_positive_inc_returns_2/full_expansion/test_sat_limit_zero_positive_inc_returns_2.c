# 0 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_sat_limit_zero_positive_inc_returns_2/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_sat_limit_zero_positive_inc_returns_2/mock_MyLib.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 2

# 7 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
void setUp(void) {
}
...
void test_sat_limit_zero_positive_inc_returns_2(void) {
  ...
  g_systemReady_b =
# 16 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 3 4
      1
# 16 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
      ;
  g_counter_u32 = 0U;
  set_SaturationEn_b(
# 18 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 3 4
      1
# 18 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
  );
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((2U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 23 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 3 4
                             ((void *)0)
# 23 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
                                 ),
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 24 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c" 3 4
                             ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_sat_limit_zero_positive_inc_returns_2.c"
                                 ),
