# 0 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c"
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_base_599_delta_NULL/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_base_599_delta_NULL/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c" 2
...
void test_base_599_delta_NULL(void) {
  ...
  InternalHelper_u32_CMockExpectAndReturn(15, 599U, (uint16_t)(5U), l_expected_u32);

  l_result_u32 = MyLib_ComputeAdjustedValue_u32(599U,
# 17 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c" 3 4
                                                ((void *)0)
# 17 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c"
  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_expected_u32)), (UNITY_INT)(UNITY_UINT32)((l_result_u32)),
                         (
# 19 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c" 3 4
                             ((void *)0)
# 19 "utExecutionAndResults/utUnderTest/test/test_base_599_delta_NULL.c"
                                 ),
