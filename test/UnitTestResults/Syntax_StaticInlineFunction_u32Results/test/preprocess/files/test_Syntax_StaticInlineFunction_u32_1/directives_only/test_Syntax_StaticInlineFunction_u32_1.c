# 0 "utExecutionAndResults/utUnderTest/test/test_Syntax_StaticInlineFunction_u32_1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Syntax_StaticInlineFunction_u32_1.c"
# 1 "utExecutionAndResults/utUnderTest/src/Syntax_StaticInlineFunction_u32.h" 1

#define TEST_SYNTAX_STATICINLINEFUNCTION_U32_H 

# 1 "utExecutionAndResults/utUnderTest/src/AleLib.h" 1
/* MyLib.h */
...
# 85 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stdarg.h" 3 4
...
# 9 "utExecutionAndResults/utUnderTest/src/AleLib.h" 2
...
# 10 "utExecutionAndResults/utUnderTest/src/AleLib.h" 2
...
/**
 * @brief Inline function prototype.
 */
...
# 5 "utExecutionAndResults/utUnderTest/src/Syntax_StaticInlineFunction_u32.h" 2

/**
 * @brief Static inline function definition used to validate static inline handling.
 */
uint32_t Syntax_StaticInlineFunction_u32(uint32_t value_u32);


# 2 "utExecutionAndResults/utUnderTest/test/test_Syntax_StaticInlineFunction_u32_1.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_Syntax_StaticInlineFunction_u32_1.c" 2

# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Syntax_StaticInlineFunction_u32_1/mock_AleLib.h" 1
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Syntax_StaticInlineFunction_u32_1/mock_AleLib.h" 2
...
#define Syntax_ReusesMyLibServices_u32_Ignore() TEST_FAIL_MESSAGE("Syntax_ReusesMyLibServices_u32 requires _IgnoreAndReturn");
#define Syntax_ReusesMyLibServices_u32_IgnoreAndReturn(cmock_retval) Syntax_ReusesMyLibServices_u32_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void Syntax_ReusesMyLibServices_u32_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t cmock_to_return);
#define Syntax_ReusesMyLibServices_u32_StopIgnore() Syntax_ReusesMyLibServices_u32_CMockStopIgnore()
void Syntax_ReusesMyLibServices_u32_CMockStopIgnore(void);
#define Syntax_ReusesMyLibServices_u32_ExpectAnyArgs() TEST_FAIL_MESSAGE("Syntax_ReusesMyLibServices_u32 requires _ExpectAnyArgsAndReturn");
#define Syntax_ReusesMyLibServices_u32_ExpectAnyArgsAndReturn(cmock_retval) Syntax_ReusesMyLibServices_u32_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void Syntax_ReusesMyLibServices_u32_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t cmock_to_return);
#define Syntax_ReusesMyLibServices_u32_Expect(dest_p,src_pc,add_u32) TEST_FAIL_MESSAGE("Syntax_ReusesMyLibServices_u32 requires _ExpectAndReturn");
#define Syntax_ReusesMyLibServices_u32_ExpectAndReturn(dest_p,src_pc,add_u32,cmock_retval) Syntax_ReusesMyLibServices_u32_CMockExpectAndReturn(__LINE__, dest_p, src_pc, add_u32, cmock_retval)
...
typedef uint32_t (* CMOCK_Syntax_ReusesMyLibServices_u32_CALLBACK)(MyLib_record_t* dest_p, const MyLib_record_t* src_pc, uint32_t add_u32, int cmock_num_calls);
...
#define Syntax_ReusesMyLibServices_u32_StubWithCallback Syntax_ReusesMyLibServices_u32_Stub
#define Syntax_ReusesMyLibServices_u32_ExpectWithArray(dest_p,dest_p_Depth,src_pc,src_pc_Depth,add_u32) TEST_FAIL_MESSAGE("Syntax_ReusesMyLibServices_u32 requires _ExpectWithArrayAndReturn");
#define Syntax_ReusesMyLibServices_u32_ExpectWithArrayAndReturn(dest_p,dest_p_Depth,src_pc,src_pc_Depth,add_u32,cmock_retval) Syntax_ReusesMyLibServices_u32_CMockExpectWithArrayAndReturn(__LINE__, dest_p, (dest_p_Depth), src_pc, (src_pc_Depth), add_u32, cmock_retval)
...
#define Syntax_ReusesMyLibServices_u32_ReturnThruPtr_dest_p(dest_p) Syntax_ReusesMyLibServices_u32_CMockReturnMemThruPtr_dest_p(__LINE__, dest_p, sizeof(MyLib_record_t))
#define Syntax_ReusesMyLibServices_u32_ReturnArrayThruPtr_dest_p(dest_p,cmock_len) Syntax_ReusesMyLibServices_u32_CMockReturnMemThruPtr_dest_p(__LINE__, dest_p, (cmock_len * sizeof(*dest_p)))
#define Syntax_ReusesMyLibServices_u32_ReturnMemThruPtr_dest_p(dest_p,cmock_size) Syntax_ReusesMyLibServices_u32_CMockReturnMemThruPtr_dest_p(__LINE__, dest_p, (cmock_size))
...
#define Syntax_ReusesMyLibServices_u32_IgnoreArg_dest_p() Syntax_ReusesMyLibServices_u32_CMockIgnoreArg_dest_p(__LINE__)
void Syntax_ReusesMyLibServices_u32_CMockIgnoreArg_dest_p(UNITY_LINE_TYPE cmock_line);
#define Syntax_ReusesMyLibServices_u32_IgnoreArg_src_pc() Syntax_ReusesMyLibServices_u32_CMockIgnoreArg_src_pc(__LINE__)
void Syntax_ReusesMyLibServices_u32_CMockIgnoreArg_src_pc(UNITY_LINE_TYPE cmock_line);
#define Syntax_ReusesMyLibServices_u32_IgnoreArg_add_u32() Syntax_ReusesMyLibServices_u32_CMockIgnoreArg_add_u32(__LINE__)
...
# 5 "utExecutionAndResults/utUnderTest/test/test_Syntax_StaticInlineFunction_u32_1.c" 2

void setUp(void) {}

void tearDown(void) {}

void test_Syntax_StaticInlineFunction_u32(void)
{
