# 0 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_InitSuccess_Return0/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_InitSuccess_Return0/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_InitSuccess_Return0/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c" 2
...
# 16 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c" 3 4
                                       ((void *)0)
# 16 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c"
                                           ,
                                       &input_rec);
  MyLib_UpdateGlobalRecord_CMockIgnoreArg_dest_p(17);

  result = MyLib_RunStateMachine_u8(&input_rec, 0U,
# 19 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c" 3 4
                                    ((void *)0)
# 19 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c"
  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((0U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 21 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c" 3 4
                             ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_InitSuccess_Return0.c"
                                 ),
