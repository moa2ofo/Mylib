# 0 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State1_VerifyComputeAdjustedValueCall/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State1_VerifyComputeAdjustedValueCall/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State1_VerifyComputeAdjustedValueCall/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 2
...
# 20 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 3 4
 ((void *)0)
# 20 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
 , &input_rec);
  MyLib_UpdateGlobalRecord_CMockIgnoreArg_dest_p(21);
  result = MyLib_RunStateMachine_u8(&input_rec, 0, 
# 22 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 3 4
                                                  ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
                                                      );

  MyLib_ProcessRecord_CMockExpect(24, 
# 24 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 3 4
 ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
 , (5U));
  MyLib_ProcessRecord_CMockIgnoreArg_rec_pc(25);
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(26, 200, &delta, 230);

  result = MyLib_RunStateMachine_u8(
# 28 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 3 4
                                   ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
                                       , 0, &delta);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0)), (UNITY_INT)(UNITY_UINT8 )((result)), (
# 30 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c" 3 4
 ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_State1_VerifyComputeAdjustedValueCall.c"
