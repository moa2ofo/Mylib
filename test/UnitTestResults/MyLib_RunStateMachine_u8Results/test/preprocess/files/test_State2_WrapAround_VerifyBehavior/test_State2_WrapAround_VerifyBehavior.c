...
void test_State2_WrapAround_VerifyBehavior(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(23, 0U, ((void *)0), 100U);
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((0U)), (UNITY_INT)(UNITY_UINT8)((result)), (((void *)0)), (UNITY_UINT)(32), UNITY_DISPLAY_STYLE_UINT8);
}