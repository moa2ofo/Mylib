# 0 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_ValueZero_InitSuccess/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_ValueZero_InitSuccess/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_ValueZero_InitSuccess/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c" 2
...
# 15 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c" 3 4
                                       ((void *)0)
# 15 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c"
                                           ,
                                       &input_rec);
  MyLib_UpdateGlobalRecord_CMockIgnoreArg_dest_p(16);

  result = MyLib_RunStateMachine_u8(&input_rec, 0U,
# 18 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c" 3 4
                                    ((void *)0)
# 18 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c"
  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((0U)), (UNITY_INT)(UNITY_UINT8)((result)),
                         (
# 20 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c" 3 4
                             ((void *)0)
# 20 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_ValueZero_InitSuccess.c"
                                 ),
