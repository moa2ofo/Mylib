# 0 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c" 2
...
# 19 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c" 3 4
 ((void *)0)
# 19 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c"
 , &input_rec);
  MyLib_UpdateGlobalRecord_CMockIgnoreArg_dest_p(20);

  result = MyLib_RunStateMachine_u8(&input_rec, 0, 
# 22 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c" 3 4
                                                  ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c"
                                                      );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0)), (UNITY_INT)(UNITY_UINT8 )((result)), (
# 24 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c" 3 4
 ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_State0_ValidRecPtr_VerifyUpdateGlobalRecordCall.c"
