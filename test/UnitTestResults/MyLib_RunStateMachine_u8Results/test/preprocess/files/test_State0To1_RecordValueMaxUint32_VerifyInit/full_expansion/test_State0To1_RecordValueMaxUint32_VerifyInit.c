# 0 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0To1_RecordValueMaxUint32_VerifyInit/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0To1_RecordValueMaxUint32_VerifyInit/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_State0To1_RecordValueMaxUint32_VerifyInit/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c" 2
...
void test_State0To1_RecordValueMaxUint32_VerifyInit(void) {
  MyLib_record_t input_rec = {5, 
# 16 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c" 3 4
                                (4294967295U)
# 16 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c"
                                          };
  uint8_t result;

  MyLib_UpdateGlobalRecord_CMockExpect(19, 
# 19 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c" 3 4
 ((void *)0)
# 19 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c"
 , &input_rec);
  MyLib_UpdateGlobalRecord_CMockIgnoreArg_dest_p(20);

  result = MyLib_RunStateMachine_u8(&input_rec, 0, 
# 22 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c" 3 4
                                                  ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c"
                                                      );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0)), (UNITY_INT)(UNITY_UINT8 )((result)), (
# 24 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c" 3 4
 ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_State0To1_RecordValueMaxUint32_VerifyInit.c"
