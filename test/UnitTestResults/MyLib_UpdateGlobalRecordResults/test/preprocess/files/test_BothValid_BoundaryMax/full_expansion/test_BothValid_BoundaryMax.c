# 0 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_BothValid_BoundaryMax/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_BothValid_BoundaryMax/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_BothValid_BoundaryMax/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c" 2
...
void test_BothValid_BoundaryMax(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((65535U)), (UNITY_INT)(UNITY_UINT16)((dest.id_u16)),
                         (
# 17 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c" 3 4
                             ((void *)0)
# 17 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c"
                                 ),
                         (UNITY_UINT)(17), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((4294967295U)), (UNITY_INT)(UNITY_UINT32)((dest.value_u32)),
                         (
# 18 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c" 3 4
                             ((void *)0)
# 18 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c"
                                 ),
                         (UNITY_UINT)(18), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((65535U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)),
                         (
# 19 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c" 3 4
                             ((void *)0)
# 19 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c"
                                 ),
                         (UNITY_UINT)(19), UNITY_DISPLAY_STYLE_UINT16);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((4294967295U)), (UNITY_INT)(UNITY_UINT32)((g_record.value_u32)),
                         (
# 20 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c" 3 4
                             ((void *)0)
# 20 "utExecutionAndResults/utUnderTest/test/test_BothValid_BoundaryMax.c"
                                 ),
