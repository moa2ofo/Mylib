# 0 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_DestNullSrcValid_NoChange/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_DestNullSrcValid_NoChange/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_DestNullSrcValid_NoChange/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c" 2
...
# 14 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c" 3 4
      ((void *)0)
# 14 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c"
          ,
      &src);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((0U)), (UNITY_INT)(UNITY_UINT16)((g_record.id_u16)),
                         (
# 16 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c" 3 4
                             ((void *)0)
# 16 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c"
                                 ),
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((g_record.value_u32)),
                         (
# 17 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c" 3 4
                             ((void *)0)
# 17 "utExecutionAndResults/utUnderTest/test/test_DestNullSrcValid_NoChange.c"
                                 ),
                         (UNITY_UINT)(17), UNITY_DISPLAY_STYLE_UINT32);
  do {
    if(!(g_systemReady_b)) {
    } else {
      UnityFail(((" Expected FALSE Was TRUE")), (UNITY_UINT)((18)));
    }
  } while(0);
}
