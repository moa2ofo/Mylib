# 0 "utExecutionAndResults/utUnderTest/test/test_Syntax_ReadVectorElement_u32_1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Syntax_ReadVectorElement_u32_1.c"
# 1 "utExecutionAndResults/utUnderTest/src/Syntax_ReadVectorElement_u32.h" 1

#define TEST_SYNTAX_READVECTORELEMENT_U32_H 
...
# 5 "utExecutionAndResults/utUnderTest/src/Syntax_ReadVectorElement_u32.h" 2
...
MyLib_Vector3_u32 get_SyntaxStaticVector(void);
void set_SyntaxStaticVector(MyLib_Vector3_u32 val);

# 2 "utExecutionAndResults/utUnderTest/test/test_Syntax_ReadVectorElement_u32_1.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_Syntax_ReadVectorElement_u32_1.c" 2

# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Syntax_ReadVectorElement_u32_1/mock_AleLib.h" 1
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Syntax_ReadVectorElement_u32_1/mock_AleLib.h" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_Syntax_ReadVectorElement_u32_1.c" 2

void setUp(void) {}

void tearDown(void) {}

void test_Syntax_ReadVectorElement_u32(void)
{
