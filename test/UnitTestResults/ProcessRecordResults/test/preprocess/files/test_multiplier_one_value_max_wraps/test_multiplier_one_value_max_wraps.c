...
void test_multiplier_one_value_max_wraps(void) {
  MyLib_record_t rec = {.id_u16 = 4U, .value_u32 = (4294967295U)};
  g_counter_u32 = 0U;
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)(((4294967295U))), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (((void *)0)), (UNITY_UINT)(20), UNITY_DISPLAY_STYLE_UINT32);
}