# 0 "utExecutionAndResults/utUnderTest/test/test_multiplier_two_value_zero.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_multiplier_two_value_zero.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiplier_two_value_zero/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiplier_two_value_zero/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiplier_two_value_zero/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_multiplier_two_value_zero.c" 2
...
void test_multiplier_two_value_zero(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(15, 0U, (const uint16_t *)&(uint8_t){2U}, 0U);
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 20 "utExecutionAndResults/utUnderTest/test/test_multiplier_two_value_zero.c" 3 4
                             ((void *)0)
# 20 "utExecutionAndResults/utUnderTest/test/test_multiplier_two_value_zero.c"
                                 ),
