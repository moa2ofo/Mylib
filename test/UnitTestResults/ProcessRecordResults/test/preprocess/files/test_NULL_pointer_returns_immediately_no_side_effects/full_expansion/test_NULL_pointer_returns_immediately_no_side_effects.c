# 0 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c"
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NULL_pointer_returns_immediately_no_side_effects/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NULL_pointer_returns_immediately_no_side_effects/mock_MyLib.h" 2
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_NULL_pointer_returns_immediately_no_side_effects/mock_MyLib.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c" 2
...
void test_NULL_pointer_returns_immediately_no_side_effects(void) {
  ...
  ProcessRecord(
# 14 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c" 3 4
      ((void *)0)
# 14 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c"
          ,
      5U);

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 16 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c" 3 4
                             ((void *)0)
# 16 "utExecutionAndResults/utUnderTest/test/test_NULL_pointer_returns_immediately_no_side_effects.c"
                                 ),
                         (UNITY_UINT)(16), UNITY_DISPLAY_STYLE_UINT32);
}
