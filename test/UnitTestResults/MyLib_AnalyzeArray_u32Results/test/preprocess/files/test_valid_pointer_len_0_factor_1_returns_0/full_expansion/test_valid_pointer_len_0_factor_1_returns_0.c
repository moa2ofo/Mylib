# 0 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_valid_pointer_len_0_factor_1_returns_0/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_valid_pointer_len_0_factor_1_returns_0/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_valid_pointer_len_0_factor_1_returns_0/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stddef.h" 1 3 4
# 6 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c" 2
...
# 8 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c" 2

# 9 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c"
void setUp(void) {
}
...
void test_valid_pointer_len_0_factor_1_returns_0(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 21 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c" 3 4
                             ((void *)0)
# 21 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c"
                                 ),
                         (UNITY_UINT)(21), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)((100U)), (UNITY_INT)(UNITY_UINT16)((array[0])),
                         (
# 22 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c" 3 4
                             ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_valid_pointer_len_0_factor_1_returns_0.c"
                                 ),
