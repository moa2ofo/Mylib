...
void test_counter_wraparound_from_near_max(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + 100U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (((void *)0)), (UNITY_UINT)(21), UNITY_DISPLAY_STYLE_UINT32);
}