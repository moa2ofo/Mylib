# 0 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c"
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_value_max_multiplier_one/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_value_max_multiplier_one/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c" 2
...
void test_value_max_multiplier_one(void) {
  MyLib_record_t rec = {.id_u16 = 7U,
                        .value_u32 =
# 12 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c" 3 4
                            (4294967295U)
# 12 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c"
  };
  uint32_t initial_counter = g_counter_u32;

  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(15,
# 15 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c" 3 4
                                                      (4294967295U)
# 15 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c"
                                                          ,
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter +
# 20 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c" 3 4
                                                    (4294967295U)
# 20 "utExecutionAndResults/utUnderTest/test/test_value_max_multiplier_one.c"
                                                        )),
