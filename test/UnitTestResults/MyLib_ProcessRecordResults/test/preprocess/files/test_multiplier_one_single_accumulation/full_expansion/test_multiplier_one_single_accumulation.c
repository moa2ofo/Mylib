# 0 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiplier_one_single_accumulation/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiplier_one_single_accumulation/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_multiplier_one_single_accumulation/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c" 2
...
void test_multiplier_one_single_accumulation(void) {
  ...
  MyLib_ComputeAdjustedValue_u32_CMockExpectAndReturn(15, 50U, (const uint16_t *)&(uint8_t){1U}, 0U);
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + 50U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)),
                         (
# 20 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c" 3 4
                             ((void *)0)
# 20 "utExecutionAndResults/utUnderTest/test/test_multiplier_one_single_accumulation.c"
                                 ),
