...
void test_multiplier_one_single_accumulation(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((initial_counter + 50U)), (UNITY_INT)(UNITY_UINT32)((g_counter_u32)), (((void *)0)), (UNITY_UINT)(20), UNITY_DISPLAY_STYLE_UINT32);
}