# 0 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_value_even_base/mock_MyLib.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_value_even_base/mock_MyLib.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_value_even_base/mock_MyLib.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c" 2
...
void test_record_value_even_base(void) {
  ...
  InternalHelper_u32_CMockExpectAndReturn(20, 70U, 0U, l_base_u32);
  ...
  result = MyLib_Orchestrate_u32(70U,
# 28 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c" 3 4
                                 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c"
  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_base_u32 + g_counter_u32)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 30 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c" 3 4
                             ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_record_value_even_base.c"
                                 ),
