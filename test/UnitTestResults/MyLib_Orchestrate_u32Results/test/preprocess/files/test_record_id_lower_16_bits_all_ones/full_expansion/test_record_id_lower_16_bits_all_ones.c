# 0 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16_bits_all_ones.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16_bits_all_ones.c" 2
...
# 1 "utExecutionAndResults/utUnderTest/src/MyLib.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_record_id_lower_16_bits_all_ones/mock_MyLib.h" 2
...
void test_record_id_lower_16_bits_all_ones(void) {
  ...
  InternalHelper_u32_CMockExpectAndReturn(20, 60U, 0U, l_base_u32);
  ...
  result = MyLib_Orchestrate_u32(60U,
# 28 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16_bits_all_ones.c" 3 4
                                 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16_bits_all_ones.c"
  );

  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((l_base_u32 + g_counter_u32)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 30 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16_bits_all_ones.c" 3 4
                             ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_record_id_lower_16_bits_all_ones.c"
                                 ),
