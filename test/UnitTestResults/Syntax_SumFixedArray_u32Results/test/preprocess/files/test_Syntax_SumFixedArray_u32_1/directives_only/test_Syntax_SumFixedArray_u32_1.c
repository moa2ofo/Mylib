# 0 "utExecutionAndResults/utUnderTest/test/test_Syntax_SumFixedArray_u32_1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Syntax_SumFixedArray_u32_1.c"
# 1 "utExecutionAndResults/utUnderTest/src/Syntax_SumFixedArray_u32.h" 1

#define TEST_SYNTAX_SUMFIXEDARRAY_U32_H 
...
# 5 "utExecutionAndResults/utUnderTest/src/Syntax_SumFixedArray_u32.h" 2

/**
 * @brief Function with fixed-size array parameter.
 */
uint32_t Syntax_SumFixedArray_u32(uint32_t[3] values_au32);


# 2 "utExecutionAndResults/utUnderTest/test/test_Syntax_SumFixedArray_u32_1.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_Syntax_SumFixedArray_u32_1.c" 2

# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Syntax_SumFixedArray_u32_1/mock_AleLib.h" 1
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Syntax_SumFixedArray_u32_1/mock_AleLib.h" 2
...
# 5 "utExecutionAndResults/utUnderTest/test/test_Syntax_SumFixedArray_u32_1.c" 2

void setUp(void) {}

void tearDown(void) {}

void test_Syntax_SumFixedArray_u32(void)
{
