# 0 "utExecutionAndResults/utUnderTest/test/test_x_near_max_y_ten_wraparound.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_x_near_max_y_ten_wraparound.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_x_near_max_y_ten_wraparound.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_x_near_max_y_ten_wraparound.c" 2
...
void test_x_near_max_y_ten_wraparound(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expected)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 22 "utExecutionAndResults/utUnderTest/test/test_x_near_max_y_ten_wraparound.c" 3 4
                             ((void *)0)
# 22 "utExecutionAndResults/utUnderTest/test/test_x_near_max_y_ten_wraparound.c"
                                 ),
