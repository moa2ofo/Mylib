# 0 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c" 2
...
void test_y_zero_returns_x_unchanged(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((seed)), (UNITY_INT)(UNITY_UINT32)((result)),
                         (
# 16 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c" 3 4
                             ((void *)0)
# 16 "utExecutionAndResults/utUnderTest/test/test_y_zero_returns_x_unchanged.c"
                                 ),
