...
#define DEC(n)                                                                                                                                                                                         \
  ('0' + (((n) / 10000000) % 10)), ('0' + (((n) / 1000000) % 10)), ('0' + (((n) / 100000) % 10)), ('0' + (((n) / 10000) % 10)), ('0' + (((n) / 1000) % 10)), ('0' + (((n) / 100) % 10)),               \
      ('0' + (((n) / 10) % 10)), ('0' + ((n) % 10))

/* Convert integer to hex digit literals.  */
#define HEX(n)                                                                                                                                                                                         \
  ('0' + ((n) >> 28 & 0xF)), ('0' + ((n) >> 24 & 0xF)), ('0' + ((n) >> 20 & 0xF)), ('0' + ((n) >> 16 & 0xF)), ('0' + ((n) >> 12 & 0xF)), ('0' + ((n) >> 8 & 0xF)), ('0' + ((n) >> 4 & 0xF)),           \
      ('0' + ((n) & 0xF))
...
char const info_version_internal[] = {
    'I', 'N', 'F', 'O', ':', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '_', 'v', 'e', 'r', 's', 'i', 'o', 'n', '_', 'i', 'n', 't', 'e', 'r', 'n', 'a', 'l', '[', COMPILER_VERSION_INTERNAL, ']', '\0'};
